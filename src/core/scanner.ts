...
export class WikiScanner {
  private cache: DiskCache = { version: CACHE_VERSION, entries: {} };
  private docs: Map<string, WikiDoc> = new Map();
  private watcher: FSWatcher | null = null;
  private debounceTimer: NodeJS.Timeout | null = null;

  constructor(public readonly wikiRoot: string) {}

  /**
   * 初始化扫描并加载/构建索引
   */
  async scan(): Promise<WikiDoc[]> {
  ...
  private async ensureWikiDir(): Promise<void> {
